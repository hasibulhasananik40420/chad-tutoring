...
const Footer = () => {
  return (
    ...
    <div className='mt-10 md:mt-14 lg:mt-0'>
      <a href='tel:8047620435'> <Image className='w-12 h-12' src={call} alt='call icon' /></a>
    ...
    <div className='mt-10 md:mt-14 lg:mt-0'>
      <a href='mailto:chadstutoringrva@gmail.com'> <Image className='w-12 h-12' src={inbox} alt='call icon' /></a>
      <h1 className='mt-4 text-[#242424] text-[20px] font-medium lowercase leading-[30px] '>
